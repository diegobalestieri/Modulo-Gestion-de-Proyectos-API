Feature: Gestionar Proyecto
    ...
    Scenario: Asignar Líder de Proyecto
	    Given tengo un proyecto sin líder
	    When le asigno un líder de proyecto de legajo "PeP-123123"
	    Then el proyecto pasa a tener a ese Líder de Proyecto de legajo "PeP-123123"

	Scenario: Reasignar Líder de Proyecto
		Given tengo un proyecto con líder de legajo "PoP-00100"
		When le asigno un líder de proyecto de legajo "PeP-1223322"
		Then el proyecto pasa a tener a ese Líder de Proyecto de legajo "PeP-1223322"
